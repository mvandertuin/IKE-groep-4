...
<div class="cpage">
    ...
    <div class="cpagemain">
        ...
        <p>Stel voor elk genre de slider in. De slider helemaal naar links geeft aan dat het genre niet leuk is, naar
            rechts geeft het aan dat je het genre geweldig vind.</p>
                ...
                <tr>
                    ...
                    <td>
                        <div class="question">
                            ...
                            <input type="radio" name="classical" value="5" <?php echo $checked['classical'][5]; ?>>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="question">
                            ...
                            <input type="radio" name="electronic" value="5" <?php echo $checked['electronic'][5]; ?>>
                        </div>
                    </td>
                </tr>
